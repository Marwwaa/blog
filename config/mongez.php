...
use App\Modules\Cart\Events\CartMealsEvent;
...
return [
    ...
    */
    'repositories' => [
        ...
        // 'repo-short-name' => RepositoryClassPath::class,
 		 ...
 		 'posts' => App\Modules\Posts\Repositories\PostsRepository::class,
 		 'comments' => App\Modules\Posts\Repositories\CommentsRepository::class,
    ...
    */
    'events' => [
        // 'meals.update' => [
        //     [CartMealsEvent::class, 'updateMeal'],
        // ],
        // 'meals.delete' => [
        //     [CartMealsEvent::class, 'deleteMeal'],
        // ],
        'response.send' => [
