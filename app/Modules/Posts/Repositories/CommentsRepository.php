...
use App\Modules\Posts\{Models\Comment as Model,
    Models\Comment,
    Models\Post,
    Resources\Comment as Resource,
    Filters\Comment as Filter};
...
class CommentsRepository extends RepositoryManager implements RepositoryInterface
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        Model::where('post.id', $post->id)->update([
            'post' => $post->sharedInfo()
        ]);
    }
