...
Route::group([
    ...
    Route::get('/published-categories', 'CategoriesController@getPublishedCategories');
    Route::get('/category-posts/{id}', 'CategoriesController@getCategoryPostsWithPagination');
});
